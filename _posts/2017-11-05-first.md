...
One of the very remarcable tools gives **the possibility to find the optimal learning rate** for a given dataset. Being learning rate both extremely important and quite difficult to tune (before this) I found this great news. This is how this tool looks like in action:

<img src="/img/loss_vs_lr.PNG" align="center"/>

The plot shows **Loss vs. Learning rate** for the dataset. Its easy to spot an optima learning rate before the curve flattens. 
